...
return [
    'customers' => [
        'forgot-password' => [
            ...
            'footer'               => '© Copyright 2010 - :current_year,© Copyright 2024 - :current_year, Carsoft (Registered in Cambodai). All rights reserved.',
        ...
        'account' => [
            ...
            'subscriptions' => [
                'index' => [
                    ...
                    'create-success'   => 'Subscription have been successfully added.',
                    'default-subscription'  => 'Default',
                    'default-delete'   => 'Default subscription cannot be changed.',
                    'delete'           => 'Delete',
                    'delete-success'   => 'Subscription successfully deleted',
                    'edit'             => 'Edit',
                    'edit-success'     => 'Subscription updated successfully.',
                    'empty-subscription'    => 'You have not added an subscription to your account yet.',
                    'security-warning' => 'Suspicious activity found!!!',
                    'set-as-default'   => 'Set as Default',
                    'title'            => 'Subscriptions',
                    'update-success'   => 'Subscription have been updated successfully.',
                ],
            ...
            'writables' => [
                ...
                'writable-id'    => 'Writable ID',
                'title'       => ' AdBlue/DTC/DPF/EGR ',
                'index' => [
                    'add-new'      => 'Add New',
                    'create-success'   => 'File have been successfully uploaded.',
                    'delete'           => 'Delete',
                    'delete-success'   => 'File successfully deleted',
                    'edit'             => 'Edit',
                    'edit-success'     => 'Analyze updated successfully.',
                    'empty-address'    => 'You have not added an analyze to your account yet.',
                    'security-warning' => 'Suspicious activity found!!!',
                    'set-as-default'   => 'Set as Default',
                    'title'            => 'Download Links',
                    'view'            => 'View',
                    'update-success'   => 'file have been updated successfully.',
                    'invalid-subscribed'   => 'Invalid subscribed!.',
                    'limit-upload-unavariable'   => 'File limit upload unavariable!.',
                    'empty-writable' => 'You have not files any writable yet!.',
                    'subscription-is-expire' => 'Subscription is expire',
                    'error-multi-subscribed' => 'Multi-subscribed, Please choose one!.',
                    'set-as-default-success' => 'Set as default success.'
                ],
                'create' => [
                    'add-new'    => 'Add New',
                    'vin'   => 'VIN',
                    ...
                    'select-service-request' => 'Select Service Request',
                    'set-as-default' => 'Set as Default',
                    'set-as-default-description' => 'Plan changes effective next cycle',
                    'save-and-change' => 'Save and change',
                    'view-current-plans' => 'View current plans',
                    'choose-current-plan' => 'Choose current plan',
                    'title'          => 'Writables'
                ],
                'edit' => [
                    'send-new'    => 'Send New',
                    'title'          => 'Download Links',
                    'upload'          => 'Upload',
                    'send-success'   => 'File have been Send successfully.',
                ...
                'subscrition' => [
                    ...
                    'view'            => 'View',
                    'add-new'      => 'Add New',
                    'save-as-success'   => 'Plan have been successfully saved.',
                    'delete'           => 'Delete',
                    'delete-success'   => 'File successfully deleted',
                    'edit'             => 'Edit',
                    'edit-success'     => 'Analyze updated successfully.',
                    'empty-subscrition'    => 'You have not added an subscrition to your account yet.',
                    'security-warning' => 'Suspicious activity found!!!',
                    'set-as-default'   => 'Set as Default',
                    'update-success'   => 'file have been updated successfully.',
                    'invalid-subscribed'   => 'Invalid subscribed!.',
    ...
    'components' => [
        ...
        'layouts' => [
            ...
            'footer' => [
                ...
                'footer-text'            => '© Copyright 2024 - :current_year, Carsoft (Registered in Cambodai). All rights reserved.',
                'locale'                 => 'Locale',
