                        ...
                        <x-slot:content>
                            <x-shop::form.control-group>
                                <x-shop::form.control-group.label class="required">
                                    @lang('shop::app.checkout.login.email-or-phone')
                                ...
                                <x-shop::form.control-group.control
                                    ...
                                    name="login"
                                    rules="required"
                                    :label="trans('shop::app.checkout.login.email-or-phone')"
                                    :placeholder="trans('shop::app.checkout.login.email-or-phone')"
                                    :aria-label="trans('shop::app.checkout.login.email-or-phone')"
                                    aria-required="true"
                                />
