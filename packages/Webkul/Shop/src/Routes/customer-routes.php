...
use Webkul\Shop\Http\Controllers\Customer\Account\WritableController;
...
use Webkul\Shop\Http\Controllers\Customer\Account\SubscriptionController;
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::prefix('account')->group(function () {
                ...
                Route::controller(SubscriptionController::class)->prefix('subscriptions')->group(function () {
                    Route::get('', 'index')->name('shop.customers.account.subscriptions.index');

                    Route::get('create', 'create')->name('shop.customers.account.subscriptions.create');

                    Route::post('create', 'store')->name('shop.customers.account.subscriptions.store');

                    Route::get('edit/{id}', 'edit')->name('shop.customers.account.subscriptions.edit');

                    Route::put('edit/{id}', 'update')->name('shop.customers.account.subscriptions.update');

                    Route::patch('edit/{id}', 'makeDefault')->name('shop.customers.account.subscriptions.update.default');

                    Route::delete('delete/{id}', 'destroy')->name('shop.customers.account.subscriptions.delete');
                });

                /**
                 * Writables.
                 */
                Route::controller(WritableController::class)->prefix('writables')->group(function () {

                    Route::get('/', 'index')->name('shop.customers.account.writables.index');

                    Route::get('/view/{id}', 'view')->name('shop.customers.account.writables.view');

                    Route::get('/create', 'create')->name('shop.customers.account.writables.create');

                    Route::post('/store', 'store')->name('shop.customers.account.writables.store');

                    Route::get('/edit/{id}', 'edit')->name('shop.customers.account.writables.edit');

                    Route::put('/update/{id}', 'update')->name('shop.customers.account.writables.update');
                    
                    Route::get('/download/{id}', 'update')->name('shop.customers.account.writables.download');
                ...
                Route::controller(NotificationController::class)->prefix('notifications')->group(function () {
                    ...
                    Route::get('get-notifications', 'getNotifications')->name('shop.customers.account.notification.get_notification');
                    
                    Route::get('viewed-notifications/{notifiableId}', 'viewedNotifications')->name('shop.customers.account.notification.viewed_notification');
            
                    Route::post('read-all-notifications', 'readAllNotifications')->name('shop.customers.account.notification.read_all');
                });
