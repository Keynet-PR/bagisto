        ...
        <div class="flex w-[360px] max-w-full flex-col gap-2 max-sm:w-full">
            ...
            <x-admin::accordion>
                ...
                <x-slot:content>
                    ...
                    @if ($downloadCustomerLink->model AND $downloadCustomerLink->vin)
                        <!-- Description -->
                    ...
                    <div>
                        @if ($purchased = $downloadCustomerLink->purchased)
                            ...
                            <p class="!leading-6 text-gray-600 dark:text-gray-300">Time Limit: {{ $downloadCustomerLink->purchased['time_limit'] }}</p>
                            <p class="!leading-6 text-gray-600 dark:text-gray-300">
                                Daily Download Bought : {{ $purchased['daily_download_bought'] }}
                            </p>
                            <p class="!leading-6 text-gray-600 dark:text-gray-300">
                                Daily Download Used : {{ $purchased['daily_download_used'] }}
                            </p>
                            <p class="!leading-6 text-gray-600  dark:text-gray-300">
                                Status : <span class="text-blue-600">{{ $purchased['status'] }}</span> 
                            </p>
                        @endif
