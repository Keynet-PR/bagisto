                ...
                <x-shop::form :action="route('shop.customer.session.create')">
                    ...
                    <x-shop::form.control-group>
                        <x-shop::form.control-group.label class="required">
                            @lang('shop::app.customers.login-form.email-or-phone')
                        ...
                        <x-shop::form.control-group.control
                            ...
                            rules="required"
                            value=""
                            :label="trans('shop::app.customers.login-form.email-or-phone')"
                            :placeholder="trans('shop::app.customers.login-form.email-or-phone')"
                            :aria-label="trans('shop::app.customers.login-form.email-or-phone')"
                            aria-required="true"
                        />

                        <x-shop::form.control-group.error control-name="login" />
                    </x-shop::form.control-group>
