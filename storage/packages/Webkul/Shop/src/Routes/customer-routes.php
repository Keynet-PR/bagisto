...
use Webkul\Shop\Http\Controllers\Customer\Account\DownloadCustomerLinkController;
    ...
    Route::prefix('customer')->group(function () {
        ...
        Route::group(['middleware' => ['customer']], function () {
            ...
            Route::get('wishlist', [WishlistController::class, 'index'])->name('shop.customers.account.wishlist.index');
               ...
               /**
                 * Download Customer Link.
                 */
                Route::controller(DownloadCustomerLinkController::class)->prefix('download-links')->group(function () {

                    Route::get('', 'index')->name('shop.customers.account.download-links.index');

                    Route::get('/create', 'create')->name('shop.customers.account.download-links.create');

                    Route::post('/create', 'store')->name('shop.customers.account.download-links.store');
                    Route::put('/set-as-default', 'setAsDefault')->name('shop.customers.account.download-links.set-as-default');

                    Route::get('/edit/{id}', 'edit')->name('shop.customers.account.download-links.edit');

                    Route::put('/edit/{id}', 'update')->name('shop.customers.account.download-links.update');

                    Route::get('/downloads/{id}', 'downloads')->name('shop.customers.account.download-links.download');
